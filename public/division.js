...
async function fetchDivisionTable() {
    document.getElementById('submitBtn').addEventListener('click', async function() {
        ...
        try {
            ...
            displayDivisionData(responseData);
...
async function displayDivisionData(responseData) {
...
window.onload = function() {
    fetchDivisionTable(); // Initialize the fetch and display functionality on page load
};
